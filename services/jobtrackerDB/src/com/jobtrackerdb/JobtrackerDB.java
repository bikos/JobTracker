...
/**
 *  Operations for service "jobtrackerDB"
 *  08/04/2015 04:17:24
 * 
 */
@SuppressWarnings("unchecked")
public class JobtrackerDB
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public com.jobtrackerdb.data.JobType getJobTypeById(Integer id, PagingOptions pagingOptions) {
        List<com.jobtrackerdb.data.JobType> rtn = ((List<com.jobtrackerdb.data.JobType> ) dsMgr.invoke(taskMgr.getQueryTask(), (JobtrackerDBConstants.getJobTypeByIdQueryName), id, pagingOptions));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
